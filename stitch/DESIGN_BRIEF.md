...
- GridPulse Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called GridPulse Lite. It should be a full-viewport reflex puzzle game where the player redirects moving energy pulses through grid nodes before the timer expires. Include gameplay and settings screens, visible score/level/lives HUD, keyboard and click controls, persistent prefer…
...
- Gameplay - GridPulse Lite
- Game Settings - GridPulse Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - GridPulse Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - GridPulse Lite
